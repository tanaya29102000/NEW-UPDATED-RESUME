  ...
  return (
    <header className="header">
      ...
      {showBlog && (
        <div className="tools-card">
          <div className="tool-item">
            <img src="coverletter.png" alt="Price List" />
            <div>
              <strong>Price List</strong>
              <p>Explore our pricing options for job seekers.</p>
            </div>
          </div>
          <hr />
          <div className="tool-item" onClick={handlePricingClick}>
            <img src="coverletter.png" alt="Pricing Page" />
            <div>
              <strong>Pricing Page</strong>
              <p>View detailed pricing options.</p>
            </div>
          </div>
        </div>
      )}
